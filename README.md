...
Get binaries from the build server [![](https://github.com/malikfalasifa/de4dot/workflows/GitHub%20CI/badge.svg)](https://github.com/malikfalasifa/de4dot/actions).
